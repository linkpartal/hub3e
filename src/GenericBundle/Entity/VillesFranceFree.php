...
class VillesFranceFree
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Infocomplementaire", inversedBy="villesFranceFreeVille")
     * @ORM\JoinTable(name="infocomplementaire_has_villes_france_free",
     *   joinColumns={
     *     @ORM\JoinColumn(name="villes_france_free_ville_id", referencedColumnName="ville_id")
     *   },
     *   inverseJoinColumns={
     *     @ORM\JoinColumn(name="InfoComplementaire_id", referencedColumnName="id")
     *   }
     * )
     */
