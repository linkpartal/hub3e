 ...
 * ContactSociete
 *
 * @ORM\Table(name="contact_societe")
 * @ORM\Entity
 */
class ContactSociete
{
    /**
     * @var int
     *
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="etablissement", referencedColumnName="id", onDelete="CASCADE")
     * })
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fonction", type="string", length=250, nullable=true)
     */
    private $fonction;
